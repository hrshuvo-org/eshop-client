...
export class NavService implements OnDestroy {
  ...
  public megaMenuCollapse: boolean = window.innerWidth < 1199;
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/charts/ngxcharts', title: 'ngxcharts', type: 'link' },
      ],
    },
    {
      title: 'Forms',
  ...
  menuItems : Menu[] = [
    ...
    // },
    {
      ...
      active: false,
      // children: [
      //   { path: '/dashboard01', title: 'Dashboard01', type: 'link' },
      //   { path: '/dashboard02', title: 'Dashboard02', type: 'link' },
      // ],
    },
    {
      title: 'Category',
